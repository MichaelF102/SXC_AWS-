...
import { X, CheckCircle, Sparkles, Loader2, Calendar, MapPin, Clock, User, Mail, Hash, GraduationCap, BookOpen } from "lucide-react";
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-3 rounded-xl bg-gradient-to-r from-aws-orange to-amber-600 hover:from-amber-500 hover:to-aws-orange text-black font-bold text-xs font-mono shadow-lg shadow-aws-orange/20 flex items-center justify-center gap-2 transition-all disabled:opacity-50 cursor-pointer"
            >
              {loading ? (
                <>
